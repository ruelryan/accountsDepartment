          ...
          return (
            <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {role.day && (
                  <span className={`px-3 py-1 rounded-full text-sm font-medium border ${getDayColor(role.day)}`}>
                    {role.day}
                  </span>
                )}
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {role.shift && shift && (
                    <div className="p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="font-semibold text-blue-700">{shift.name}</div>
                    </div>
                  )}
                  ...
                  {role.location && (
                    <div className="p-3 bg-green-50 rounded-lg">
                      ...
                      <div className="font-semibold text-green-700">{role.location}</div>
                    </div>
                  )}
                  ...
                  {role.boxNumber && (
                    <div className="p-3 bg-yellow-50 rounded-lg">
                      ...
                      <div className="font-semibold text-yellow-700">Box #{role.boxNumber}</div>
                    </div>
                  )}
                ...
                <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-medium text-yellow-800">Key Instructions</span>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          {volunteer.roles.filter(role => role.boxNumber).map((role, index) => (
            <div key={index} className="p-4 bg-teal-50 border border-teal-200 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-medium text-teal-900">Box #{role.boxNumber}</h4>
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
